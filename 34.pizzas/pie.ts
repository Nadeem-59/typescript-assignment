//Ques no 34:Pizzas: Think of at least three kinds of your favorite pizza. 
...
let pizzas : string[] = ['chicken tikka','afghani creamy','fajita'];
...
console.log( `I like fajita flavor most`);
console.log(`It is not too spicy`);
console.log(`And this is a combination of  all healthy vegetables.`);
